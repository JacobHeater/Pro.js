...
(function(global) {
  ...
  var isObject = function(obj) { return isDefined(obj) && typeof obj === 'object'; };
  var isClass = function(obj) { return isObject(obj) && obj.isClass === true; };
  var enumerateObject = function(obj, callback) { for (var key in obj) { callback(key, obj[key]); } };
