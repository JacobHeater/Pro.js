(function (pro) {
    ...
    pro.module('state', pro.object()).module('client', pro.object({
        ...
        session: pro.object({
            ...
            lookup: new pro.collections.dictionary(),
            ...
            deserialize: function () {
                if (global.sessionStorage && pro.parseJson(global.sessionStorage.getItem(this.id))) {
                    this.lookup = pro.collections.asEnumerable(pro.parseJson(global.sessionStorage.getItem(this.id))).toDictionary();
                }
                return this;
            }
        }),
        local: pro.object({
            ...
            deserialize: function () {
                if (global.localStorage && pro.parseJson(global.localStorage.getItem(this.id))) {
                    this.lookup = pro.collections.asEnumerable(pro.parseJson(global.localStorage.getItem(this.id))).toDictionary();
                }
                return this;
            }
        }),
