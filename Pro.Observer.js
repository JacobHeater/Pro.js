        ...
        this.observers = {
            ...
            remove: function(observer) {
                if(this.contains(observer)) {
                    private.index.splice(private.index.indexOf(observer), 1);
                    if(private.index.length <= 0) {
            ...
            clear: function() {
                private.index.length = 0;
                _subject.observing = false;
            },
            contains: function(observer) {
                return private.index.indexOf(observer) > -1;
            },
            findByObject: function(object) {
                return private.index.filter(function(o) {
