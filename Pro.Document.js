        ...
        text: function (text, appendPrepend) {
            ...
            if (pro.isDefined(text)) {
                ...
                if (pro.isDefined(_text)) {
                    this.forEach(function (i, o) {
                        var existing = pro.isDefined(o.innerText) ? o.innerText : o.textContent;
                        var content = appendPrepend === 1 ? existing + _text : appendPrepend === 2 ? _text + existing : text;
                        if (pro.isDefined(o.innerText)) {
                            o.innerText = content;
                        } else {
                ...
                var native = this.first();
                var content = pro.isDefined(native) ? pro.isDefined(native.innerText) ? native.innerText : native.textContent : "";
                return content;
            }
            return this;
        },
